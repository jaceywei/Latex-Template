...
\paragraph{说明}
这里对LaTeX图片插入功能做了打包，封装成了下面的 \texttt{fig, figu, minifig, minifigure} 函数，分别用于插入单张图片和并排图片，并对两个功能分别制作了简约版和完整版，以下是\texttt{template.tex}中的代码：
